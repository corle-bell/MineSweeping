...
namespace InfinityCode.uContext.Integration
{
    ...
    public class EnhancedHierarchy: EditorWindow
    {
        ...
        private void OnGUI()
        {
            EditorGUILayout.HelpBox("uContext has detected the presence of Enhanced Hierarchy in the project.\nFor the best work of both assets together, we recommend the following changes in the settings:", MessageType.Warning);
            disableErrorIcons = EditorGUILayout.ToggleLeft("uContext / Show Error Icons - OFF", disableErrorIcons);
