...
namespace InfinityCode.uContext
{
    ...
    public static class SceneViewManager
    {
        ...
        private static void OnMouseUp(Event e) 
        {
            ...
            {
#if UNITY_2020_1_OR_NEWER && !UNITY_2021_1
        ...
        public static void UpdateLastItems(SceneView view)
        {
            ...
            if (_lastGameObjectUnderCursor != null)
            {
                ...
                if (meshFilter != null && HandleUtilityRef.IntersectRayMesh(_screenRay, meshFilter.sharedMesh, meshFilter.transform.localToWorldMatrix, out hit))
                {
