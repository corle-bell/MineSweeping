...
namespace InfinityCode.uContext.Windows
{
    public class CheckIntegrityWindow : EditorWindow
    {
        ...
        {
            string nspace = "InfinityCode.uContext.UnityTypes";
