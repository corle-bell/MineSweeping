...
namespace Bm
{
    ...
    {
        [MenuItem("Tools/EnumEditor/打开编辑器", false)]
        static void Open()
        {
        ...
        public string storePath = "Assets/Game/ScriptRes/EnumData";
        public int selectId;
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.Space();
            BmFramework.Core.EditorTools.DrawTitle("枚举信息列表", new Color(0.15f, 0.15f, 0.15f));
        ...
        public void Read()
        {
            ...
            {
                var name = FrameworkTools.GetStringInBrackets(conent[i]);
                name = name.Replace("\"", "");
